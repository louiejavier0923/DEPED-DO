			...
			<section class= "application-content">
				...
				<section class= "one-three">
					...
					<section class= "pi-row">
						...
						<section class= "pi-row-input">
							<section class= "radio-input">
								<input type= "radio" class="civil_status" value= "Single" <?php echo('Single' == $user['CIVIL_STATUS']) ? 'checked' : ''?>><p>Single</p>
							</section>
							<section class= "radio-input">
								<input type= "radio" name="civil_status" value= "Married" <?php echo('Married' == $user['CIVIL_STATUS']) ? 'checked' : ''?>><p>Married</p>
							</section>
							<section class= "radio-input">
								<input type= "radio" name="civil_status" value= "Widow" <?php echo('Widow' == $user['CIVIL_STATUS']) ? 'checked' : ''?>><p>Widowed</p>
							</section>
							<section class= "radio-input">
								<input type= "radio" name="civil_status" value= "Separated" <?php echo('Separated' == $user['CIVIL_STATUS']) ? 'checked' : ''?>><p>Separated</p>
							</section>
							<section class= "radio-input">
								<input type= "radio" name="civil_status" value= "Others" <?php echo('Others' == $user['CIVIL_STATUS']) ? 'checked' : ''?>><p>Other`s</p>
							</section>
						</section>
					</section>
					<section class= "pi-row">
							...
							<p>9. Blood Type</p>
								...
								<section class= "one-three">
									<section class= "pi-row">
										...
										<section class= "pi-row-input">
											<section class= "radio-input">
												<input type= "radio" name= "citi" value= "Filipino" <?php echo('Filipino' == $user['CITIZENSHIP']) ? 'checked' : ''?>>
												<p>Filipino</p>
											</section>
											<section class= "radio-input">
												<input type= "radio" name= "citi" value= "Dual Citizenship" <?php echo('Dual Citizenship' == $user['CITIZENSHIP']) ? 'checked' : ''?>>
												<p>Dual Citizenship</p>
											</section>
											<section class= "radio-input">
												<input type= "radio" name= "citi" value= "By Birth" <?php echo('By Birth' == $user['CITIZENSHIP']) ? 'checked' : ''?>>
												<p>By Birth</p>
											</section>
											<section class= "radio-input">
												<input type= "radio" name= "citi" value= "By Naturalization" <?php echo('By Naturalization' == $user['CITIZENSHIP']) ? 'checked' : ''?>>
